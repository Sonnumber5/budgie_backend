export const AccountBalanceQueries = {
    ...
    UPDATE_ACCOUNT_BALANCE: `UPDATE account_balances SET account_name = $1, account_type = $2, balance = $3
    WHERE user_id = $4 AND id = $5
    RETURNING id, account_name AS "accountName", account_type AS "accountType", balance, created_at AS "createdAt", updated_at AS "updatedAt"`,
    DELETE_ACCOUNT_BALANCE: `DELETE from account_balances WHERE user_id = $1 AND id = $2`,
    DELETE_ALL_ACCOUNT_BALANCES: `DELETE from account_balances WHERE user_id = $1`
}