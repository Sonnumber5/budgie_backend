export const BudgetQueries = {
    ...
    FIND_MONTHLY_BUDGET_BY_MONTH: `SELECT id, month, expected_income AS "expectedIncome" from monthly_budgets WHERE user_id = $1 AND month = $2`,
    FIND_MONTHLY_BUDGET_BY_ID: `SELECT id, month, expected_income AS "expectedIncome" from monthly_budgets WHERE user_id = $1 AND id = $2`,
